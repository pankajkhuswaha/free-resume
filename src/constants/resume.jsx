...
const resumeDetails = {
  ...
  skills: [
    ...
    { name: "Angular Js (Framework)", level: "Intermediate", type: "Frontend" },
    ...
    {
      name: "Redux js (State management)",
      level: "Advanced",
      type: "Frontend",
    },
    ...
    { name: "Jquery", level: "Intermediate", type: "Frontend" },
    { name: "Rest API's", level: "Intermediate", type: "Backend" },
  ],
